// Fork of "Psychedelic Dodec experiment" by None. https://shadertoy.com/view/-1
// 2022-11-17 02:05:59
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
 vec2 mouse = (vec2(0.0) == vec2(0.)) ? vec2(0.5) : vec2(0.0)/iResolution.xy;
  ...
  col *= 1.0 - mytanh(0.05+length(8.0*d));
